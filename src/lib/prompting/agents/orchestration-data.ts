/**
 * @stsgs/prompting -- 12 Orchestration Pattern Definitions
 * Pure data: all orchestration pattern objects used by the orchestration API.
 */

import type { OrchestrationPattern } from '../core/types'
