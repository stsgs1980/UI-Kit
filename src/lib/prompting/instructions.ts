...
// ─── Re-export types & data ─────────────────────────────────
export type { InstructionCategory, InstructionMeta, InstructionEntry } from './instructions-data'
export { INSTRUCTIONS, AI_RULES } from './instructions-data'

import { INSTRUCTIONS, AI_RULES } from './instructions-data'
import type { InstructionCategory, InstructionMeta, InstructionEntry } from './instructions-data'
